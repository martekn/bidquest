...
<template>
  <div class="group/card relative flex flex-col space-y-5">
    ...
    <div class="space-y-5">
      <RouterLink
        class="overflow-wrap-anywhere line-clamp-2 font-accent font-medium outline-none before:absolute before:inset-0 before:rounded before:bg-transparent hover:underline hover:decoration-grey-400 hover:underline-offset-4 focus-visible:before:ring-2 focus-visible:before:ring-black focus-visible:before:ring-offset-4"
